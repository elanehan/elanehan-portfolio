...
export const projectsData = [
    {
        id: 1,
        projectName: 'Tattoo Trace',
        projectDesc: 'This project aims to develop a tool to assist law enforcement agencies in identifying criminal tattoos from various inputs, such as images or videos. This project is affiliated with the UMass Rescue Lab.',
        tags: ['Nest.JS', 'REST API', 'Node.JS', 'TypeScript', 'HTML', 'CSS'],
        code: 'https://github.com/UMass-Rescue/TattooTrace',
        demo: 'https://docs.google.com/presentation/d/1QufJU_rB2Fl7mgphrLVKAJpuVML53e8QKgITp-AkHVI/edit?usp=sharing',
        image: one
    },
    {
        id: 2,
